...
\if \cvtype d
%developer
{\quad}I've been working as a developer for over six years, programming mainly in \textbf{C++}, but also \textbf{Python}, \textbf{Rust} and \textbf{Java}, among others. I also have experience in other technologies, leadership roles and teaching. What I enjoy the most in programming is documenting, writing unit tests, refactoring legacy code and sharing knowledge. My extensive background in Mathematics, Science and Education sometimes comes in handy.
...
\textsc{January 2022} & Developer at \textsc{Velocix}\\
